        ...
        Surface(
            ...
            ModalNavigationDrawer(
                ...
                Scaffold(
                    ...
                    LaunchedEffect(""){
                        if (index != null) {
                            var trainingLE = trainingViewModel.getTrainingByIndex(index)
                            Log.i("Main", trainingLE.toString())
                            training.value = trainingLE
                        }
                    }
                    val trainingIn = training.value

                    Log.i("Main", trainingIn.distance.toString())
                }
            }
        }
    }
